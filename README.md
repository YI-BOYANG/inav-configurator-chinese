...
INAV 由于尚未支持多语言,为了更符合国人使用习惯,故在官方项目上开辟了一个中文分支,此分支将保持和INAV官方的发布版本保持同步，且只对英文内容做中文化处理，不做任何代码改进和BUG修复，如您需要反馈BUG或参与地面站的开发工作，请移步INAV官方项目。
...
# INAV Configurator（以下为INAV官方的自述文件）
